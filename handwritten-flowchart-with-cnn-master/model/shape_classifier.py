...
from model.frcnn.cnn import CNN
from model.frcnn.roi_helpers import ROIHelpers
from model.frcnn.data_generator import Metrics
from model.frcnn.utilities.config import Config
from model.frcnn.utilities.parser import Parser
from model.frcnn.utilities.image_tools import ImageTools
...
class ShapeClassifier(object):
	...
	def predict(self, image, display_image):
		...
		if(display_image):
			...
			cv2.imshow('test', cv2.resize(img,(1980,1080)))
			cv2.waitKey(0)
	...
	def __load_config(self, results_path):
		...
		R-CNN.
		"""
		config_path = "model/training_results/config.pickle"
